...
class Rsvmng(models.Model):
    user = models.ForeignKey('cstmng.CstModel', on_delete=models.CASCADE, verbose_name='사용자')
    goods_nm = models.ForeignKey('goodsmng.GoodsModel', on_delete=models.CASCADE, verbose_name='상품')
