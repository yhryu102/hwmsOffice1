...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='TbSumUserInfo',
            fields=[
                ('user_sn', models.PositiveIntegerField(primary_key=True, serialize=False)),
                ('user_nm', models.CharField(blank=True, max_length=60, null=True)),
                ('user_id', models.CharField(blank=True, max_length=20, null=True)),
                ('user_se', models.CharField(blank=True, max_length=20, null=True)),
                ('work_branch', models.CharField(blank=True, choices=[('7Q', 'Fumyhung'), ('2Q', 'Branch-#2')], max_length=4, null=True)),
                ...
                ('telno', models.CharField(blank=True, max_length=60, null=True)),
